...
export function getAheadDiscoveryConfig(env: NodeJS.ProcessEnv = process.env) {
  return {
    ...
    knowledgeMaxChars: num('DISCOVERY_KNOWLEDGE_MAX_CHARS', 5000),
    knowledgeMatchRadiusMeters: num('DISCOVERY_KNOWLEDGE_MATCH_RADIUS_M', 1000),
    cityContextRadiusMeters: num('DISCOVERY_CITY_CONTEXT_RADIUS_M', 20000),
    ...
    areaCacheTtlSeconds: num('AHEAD_DISCOVERY_AREA_CACHE_TTL_SECONDS', 3600),
    areaCachePrecision: num('AHEAD_DISCOVERY_AREA_CACHE_PRECISION', 6),
    providerErrorBackoffSeconds: num('AHEAD_DISCOVERY_ERROR_BACKOFF_SECONDS', 300),
