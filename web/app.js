...
async function startWalking() {
  ...
  try {
    ...
    state.initialScanComplete = false; state.walkStatus = t('map.searching'); state.movementMode = 'walking'; state.speedKmh = null; setRadarScanning(true); document.querySelector('#start-walk').hidden = true; document.querySelector('#stop-walk').hidden = false; status.textContent = state.walkStatus; document.querySelector('#top-status').textContent = movementModeLabel();
